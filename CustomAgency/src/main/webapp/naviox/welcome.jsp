...
In CustomAgency-labels_en.properties:
CustomAgency=My application
CustomAgency[description]=My application does this and that

In CustomAgency-messages_en.properties:
